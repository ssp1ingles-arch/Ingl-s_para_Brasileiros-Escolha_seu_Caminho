...
> Leia também o `REGRAS_GERAIS.md` na raiz. **Este arquivo substitui as regras de livro dos demais Sistemas** para S20, S21 e S24 — e só para eles.
...
| **S24** | `Sistema 24 — Gramática Avançada · Cambridge` | 3 |

Nenhum outro Sistema segue estas regras. Um livro que sair de S20/S21/S24 volta a seguir as regras do Sistema de destino.
