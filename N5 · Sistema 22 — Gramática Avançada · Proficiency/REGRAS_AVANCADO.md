# REGRAS_AVANCADO — Sistemas 22, 23 e 24 · Gramática Avançada

> Leia também o `REGRAS_GERAIS.md` na raiz. **Este arquivo substitui as regras de livro dos demais Sistemas** para S22, S21 e S22 — e só para eles.
...
|---|---|---|
| **S22** | `Sistema 22 — Gramática Avançada · Proficiency` | 7 |
| **S21** | `Sistema 21 — Baseado em Livros V12 Gramática Avançada` | 5 |
| **S22** | `Sistema 22 — Baseado em Livros V13 Gramática Avançada` | 3 |

Nenhum outro Sistema segue estas regras. Um livro que sair de S22/S21/S22 volta a seguir as regras do Sistema de destino.

> **Atenção:** o **S04 (`Sistema 04 — Gramática Básica`) NÃO é avançado.** É gramática básica A1–A2 (For Dummies e afins) e segue as regras normais de livro — `REGRAS_GERAIS.md` + o `REGRAS.md` da própria pasta.
...
Público destes três Sistemas: **quem já tem base sólida.** Quem ainda está construindo deve ir aos Sistemas 03, 05, 12 e 13 primeiro.
...
Um commit por livro implementado, no padrão do projeto: `feat(S22): <nome do livro> — livroNN`.
