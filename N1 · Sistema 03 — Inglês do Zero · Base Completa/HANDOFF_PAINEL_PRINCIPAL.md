...
- Ler todos os 27 sistemas e escolher um **título curto e honesto** para o Sistema 03 (ex: "Inglês do Zero ao Avançado" ou "Base Completa — 27 Sistemas"). Decidir com base no conteúdo — não usar placeholder.
...
.portal-card[data-sistema="01"] { --accent-for-this-card: /* cor do S03 */; }
...
O Sistema 03 já usa: cards de lição, frases crescentes, 1000 frases, textos curtos, shadowing.
...
O hub de cada sistema deve seguir o mesmo padrão visual dos outros, mas com **cor de acento própria** (diferente de S03 e S02).
