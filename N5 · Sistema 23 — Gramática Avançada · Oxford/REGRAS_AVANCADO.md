...
> Leia também o `REGRAS_GERAIS.md` na raiz. **Este arquivo substitui as regras de livro dos demais Sistemas** para S20, S23 e S22 — e só para eles.
...
| **S23** | `Sistema 23 — Gramática Avançada · Oxford` | 5 |
| **S22** | `Sistema 22 — Baseado em Livros V13 Gramática Avançada` | 3 |

Nenhum outro Sistema segue estas regras. Um livro que sair de S20/S23/S22 volta a seguir as regras do Sistema de destino.
